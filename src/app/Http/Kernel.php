...
use App\Http\Middleware\CheckAffiliateAvailabilityMiddleware;
...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareGroups = [
        'web' => [
            ...
            RestrictDemoMode::class,
            HttpsMiddleware::class,
            SoftwareVerification::class,
            PurchaseValidation::class
        ],

        'admin' => [ RestrictDemoMode::class, RedirectIfNotAuthenticated::class ],
        'user'  => [ RestrictDemoMode::class, RedirectIfNotAuthenticated::class ],
    ...
    protected $routeMiddleware = [
        ...
        'check.affiliate.availability' => CheckAffiliateAvailabilityMiddleware::class,
    ];
}
