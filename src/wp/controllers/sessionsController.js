    ...
    try{
        const checkLicense = await axios.post(
          ...
          queryString.stringify({
            domain_check: domain,
            env_purchase_key: process.env.PURCHASE_KEY,
          }),
          {
            headers: {
