...
<main class="main-body">
    <div class="container-fluid px-0 main-content">
        ...
        <form action="{{route('user.communication.sms.campaign.store')}}" class="step-content" method="POST" enctype="multipart/form-data">
            @csrf
        ...
        selectApiGateway.empty();
            if (method == "{{ \App\Enums\System\Gateway\SmsGatewayTypeEnum::ANDROID->value }}") {
                ...
                apiGatewayTypeSelect.change(function() {
                    ...
                    if (selectedType && apiGateways[selectedType]) {
