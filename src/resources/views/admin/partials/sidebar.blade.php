            ...
            <ul class="menus scrollable-menu">
                                        ...
                                        <div class="side-menu-dropdown collapse {{menuShow($isMemberActive)}}" id="member">
                                            <ul class="sub-menu">
                                                <li class="sub-menu-item">
                                                    <a class="sidebar-menu-link {{ request()->routeis('admin.user.index') || request()->routeis('admin.user.trashed') ? 'active' : '' }}" href="{{route('admin.user.index')}}">
                                ...
                                <ul class="sidebar-menu">
                                    <li class="sidebar-menu-item">
                                        ...
                                        <div class="side-menu-dropdown collapse {{menuShow($isPaymentActive)}}" id="automaticPayment">
                                            <ul class="sub-menu">
                                                <li class="sub-menu-item">
                                                    <a class="sidebar-menu-link {{ request()->routeis('admin.payment.withdraw.index') ? 'active' : '' }}" href="{{route('admin.payment.withdraw.index')}}" >
                                                        <p>{{ translate("Withdraw Methods") }}</p>
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                ...
                <li class="menu">
                    <a class="menu-link {{menuActive(array_merge($isCreditLogsActive, $isReportsActive))}}" href="javascript:void(0)">
                        ...
                        <span class="menu-label">{{ translate("Report") }} @if($pending_manual_payment_count > 0 || $pending_withdraw_payment_count > 0 ) <span class="text-danger fs-16">*</span> @endif</span>
                        <span class="menu-arrow">
                            <i class="ri-arrow-right-s-line"></i>
                        </span>
                    </a>
                                    ...
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-link {{menuShow($isReportsActive) != 'show' ? 'collapsed' : ''}}" data-bs-toggle="collapse" href="#activityRecords" role="button" aria-expanded="false" aria-controls="activityRecords">
                                            ...
                                            <p> {{ translate("Activity Records") }} 
                                                @if($pending_manual_payment_count > 0 || $pending_withdraw_payment_count > 0)
                                        ...
                                        <div class="side-menu-dropdown collapse {{menuShow($isReportsActive)}}" id="activityRecords">
                                            <ul class="sub-menu">
                                                ...
                                                <li class="sub-menu-item">
                                                <a class="sidebar-menu-link {{ request()->routeis('admin.report.record.payment') || request()->routeis('admin.report.payment.detail')  ? 'active' : '' }}" href="{{ route('admin.report.record.payment') }}">
                                                ...
                                                <li class="sub-menu-item">
                                                    <a class="sidebar-menu-link {{ request()->routeis('admin.report.record.affiliate') ? 'active' : '' }}" href="{{ route('admin.report.record.affiliate') }}">
                                                        <p>{{ translate("Affiliate History") }}</p>
                                                    </a>
                                                </li>
                                                <li class="sub-menu-item">
                                                <a class="sidebar-menu-link {{ request()->routeis('admin.report.record.withdraw') || request()->routeis('admin.report.withdraw.detail') ? 'active' : '' }}" href="{{ route('admin.report.record.withdraw') }}">
                                                    <p>{{ translate("Withdraw History") }}</p>
                                                    @if($pending_withdraw_payment_count > 0)
                                                        <span class="fs-12 i-badge pill danger-soft">
                                                           {{ $pending_withdraw_payment_count }}
                                                        </span>
                                                    @endif
                                                </a>
                                                </li>
                        ...
                        <div class="sub-menu-container">
                            ...
                            <div class="sidebar-menu-container">
                                <ul class="sidebar-menu">
                                    ...
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-link {{ request()->type == "ai" ? 'active' : '' }}" href="{{ route("admin.system.setting", ["type" => "ai"]) }}">
                                            <span>
                                                <i class="ri-bard-line"></i>
                                            </span>
                                            <p>{{ translate("AI Management") }}</p>
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item">
